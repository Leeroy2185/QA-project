...
class EditForm(FlaskForm):
    carreg = QuerySelectField('Select reg to edit', query_factory=carlist, allow_blank=True, get_label='reg')
    newreg = StringField('Correct registration number', validators=[DataRequired()])
    submit = SubmitField("Update Reg")

class RemoveForm(FlaskForm):
    carreg = QuerySelectField('Select Car to Delete', query_factory=carlist, allow_blank=True, get_label='reg')
